...
classificadorOlho = cv2.CascadeClassifier("haarcascade_eye.xml")  #obs caminho  !!
...
#caminhos a serem implmentados .. obs !!!
caminho_Fotos_Tiradas ='C:/Users/Jk_cu/OneDrive/Área de Trabalho/J k/Programs python JK/5/src/fotos.png'
caminho_Fotos_Tiradas1 =r'C:\Users\Jk_cu\OneDrive\Área de Trabalho\J k\Programs python JK\5\src\fotos.png'
caminho_Fotos_Tiradas2 ='C:\\Users\\Jk_cu\\OneDrive\\Área de Trabalho\\J k\\Programs python JK\\5\\src\\fotos.png'	
#C:\Users\Jk_cu\OneDrive\Área de Trabalho\J k\Programs python JK\5\src  caminho  obs  !!!
		...
		for (ox, oy, ol, oa) in olhosDetectados:
			...
			if cv2.waitKey(1) & 0xFF == ord('c' or 'C'): #(0)
				if np.average(imagemCinza) > 10:
					...
					cv2.imwrite('fotos' + str(id) + '.' + str(amostra) + '.jpg', imagemFace) #grava aqui
