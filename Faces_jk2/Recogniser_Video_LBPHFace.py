...
recognise.read('C:\\Users\\Jk_cu\\OneDrive\\Documentos\\Recogniser\\trainingDataLBPH.xml')
...
while True:
    ...
    cv2.imshow('Sistema de Reconhecimento Facial LBPH', gray)                            # Show the video
    
    if cv2.waitKey(1) & 0xFF == ord('s' or 'S'):                                       # Quit if the key is Q
        break
