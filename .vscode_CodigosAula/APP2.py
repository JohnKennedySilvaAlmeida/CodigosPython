...
while True: # loop principal
    ...
    print('[2]  Cadastro produto ') # menu pricipal 
    ...
    if op == 1:
        while True: # 1 loop 
            ...
            op1 = input(' Deseja Continuar [s] ou [n] :')
            print('-='*15)
        ...
        while True: # 3 looop remover itens 
            ...
            if op3 =='s' or op3 =='S': print('Continue...')
            elif op3 =='n' or op3 =='N': break
            else: print('Opção Invalida'.center(60))  
# --------------------------------------------------------------- obs!!!
    elif op == 4:
        t = meuPedido.getTotal() # 5 objs *
        print(f'Total -> {t}')
    
    elif op == 5:
        meuPedido.imprimir() # 6 objs *
