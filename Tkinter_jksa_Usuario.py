from Tkinter_jksa_BD import Banco   #importa BD - Class
...
class Usuarios(object):
   ...
   #construtor
    ...
    def insertUser(self): #inserir usuario 
    ...
    def selectUser(self, idusuario): #selecionar 
        banco = Banco()
        try:
